...
## 🎯 Deliverables
- [ ] `Product` and `Category` Zod schemas.
- [ ] `src/lib/mock/products.ts` repository.
- [ ] Centralized `getBrandingProducts` helper.
...
## ✅ Acceptance Criteria
- [ ] Mock repository contains at least 8 varied branding products.
- [ ] All products pass the Zod validation check.
- [ ] Products are correctly categorized according to the sidebar requirements in the design.
